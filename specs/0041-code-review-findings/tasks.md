...
- [x] T004 [P1] [US2] Update commands/speckit.specify.md:57-60 to reference `speckit feature create` (OC002, OD005)
...
- [x] T009 [P2] [US1] Add input sanitization in speckit-state.sh jq calls (HD001)
- [x] T010 [P2] [US1] Add input sanitization in speckit-roadmap.sh grep/jq calls (HD001)
- [x] T011 [P2] [US1] Add trap cleanup for temp files in speckit-state.sh (HD002)
- [x] T012 [P2] [US1] Add trap cleanup for temp files in speckit-roadmap.sh (HD002)
- [x] T013 [P2] [US1] Validate placeholder goals before write in speckit-roadmap.sh:626 (MF001)
- [x] T014 [P2] [US1] Remove jq debug leftover in speckit-state.sh:624 (BP003)
...
- [x] T017 [P3] [US3] Simplify registry clean in speckit-state.sh:604-645 (RF002)
...
- [x] T021 [P3] [US3] Add error handling on external commands in speckit-import.sh (RF007)
...
- [x] T022 [P4] [US4] Add detect_test_runner() function to speckit-gate.sh (MF002)
...
- [x] T026 [P4] [US4] Add backlog priority column parsing to speckit-roadmap.sh (MF003)
...
- [x] T032 [P3] [US1] Quote parameter expansion in speckit-context.sh:307 (BP004)
- [x] T033 [P3] [US1] Add comment for magic number in speckit-roadmap.sh:743 (BP005)
- [x] T034 [P3] [US1] Add input validation error check in speckit-feature.sh:71-80 (BP006)
- [x] T035 [P3] [US1] Use grep -F for literal patterns in speckit-roadmap.sh (HD004)
- [x] T036 [P3] [US1] Add require_command() checks in speckit-roadmap.sh (HD003)

### US3 - Clean Codebase

- [x] T037 [P3] [US3] Store status as text, convert to emoji for display in speckit-roadmap.sh (OE003)
- [x] T038 [P3] [US3] Use validation config for check_sections() in speckit-gate.sh (OE004)
- [x] T039 [P3] [US3] Inline or delete unused helpers in speckit-roadmap.sh (OC004)
...
| commands/speckit.specify.md | T004 |
| README.md | T005, T006, T030, T031 |
| lib/common.sh | T008, T019 |
| scripts/bash/speckit-state.sh | T009, T011, T014, T015, T016, T017, T018 |
| scripts/bash/speckit-roadmap.sh | T010, T012, T013, T26, T33, T35, T36, T37, T39 |
| scripts/bash/speckit-gate.sh | T022-T025, T038 |
| ROADMAP.md | T027 |
| CLAUDE.md | T028, T029 |
| scripts/bash/speckit-context.sh | T032 |
| scripts/bash/speckit-feature.sh | T034 |
| scripts/bash/speckit-import.sh | T021 |
